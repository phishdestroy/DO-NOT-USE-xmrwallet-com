...
function menuOpen(e){"click"==e.type&&header.classList.toggle("header-active")}var swiper=new Swiper(".news-slider",{slidesPerView:3,freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:30,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},769:{slidesPerView:2},921:{slidesPerView:3}}});if(document.getElementsByClassName("header-bar").length){var bar=document.querySelector(".header-bar"),header=document.querySelector(".header");bar.addEventListener("click",menuOpen)}if(document.getElementsByClassName("drop1").length){var drop=document.querySelector(".drop1");drop.onclick=function(e){e.target;this.classList.contains("active")?drop.classList.remove("active"):drop.classList.add("active")},document.addEventListener("click",function(e){drop.contains(e.target)||drop.classList.remove("active")})}if(document.getElementsByClassName("drop2").length){var drop2=document.querySelector(".drop2");drop2.onclick=function(e){e.target;this.classList.contains("active")?drop2.classList.remove("active"):drop2.classList.add("active")},document.addEventListener("click",function(e){drop2.contains(e.target)||drop2.classList.remove("active")})}